class DropBoxController{
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyD7lrPrpRG2IVqSJ2FKF_PdqKcNPeX62A0",
            authDomain: "dropbox-clone-620e1.firebaseapp.com",
            databaseURL: "https://dropbox-clone-620e1-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-620e1",
            storageBucket: "dropbox-clone-620e1.appspot.com",
            messagingSenderId: "1011123445141",
            appId: "1:1011123445141:web:9101c69ed5746330626a9c",
            measurementId: "G-Q8EENS0JK7"
          };
          // Initialize Firebase
    ...
    initEvents(){
        ...
        this.inputFilesEl.addEventListener('change', event =>{
            ...
            this.btnSendFileEl.style.disabled = true;
    ...
    uploadComplete(){
        ...
        this.btnSendFileEl.style.disabled = false;
    ...
    */
    ...
    readFiles(){
        ...
        //on no fire base significa preste atenção no que eu estou te passando
